...
import { cartCountSubscriber, cartCountService } from "../../../../_partials/dropdowns/dataTransferService"
...
export function UserProfileDropdown() {
  ...
  // constructor(props) {
  //   super(props);
  //   this.state = { anchorEl: null, cartCount: 0 }
  // };
        ...
        >
          ...
          >
            ...
            <span className="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">
              ...
              {JSON.parse(localStorage.getItem("persist:v713-demo1-auth")) != null ?
                JSON.parse(localStorage.getItem("persist:v713-demo1-auth")).user != undefined ?
                  JSON.parse(JSON.parse(localStorage.getItem("persist:v713-demo1-auth")).user).data.stFirstName != "" ? JSON.parse(JSON.parse(localStorage.getItem("persist:v713-demo1-auth")).user).data.stFirstName : "dev" : "dev" : "dev"}
            ...
            {!layoutProps.light && (
              ...
              >
                ...
                <div className="text-white m-0 flex-grow-1 mr-3 font-size-h5">
                  {JSON.parse(localStorage.getItem("persist:v713-demo1-auth")) != null && JSON.parse(localStorage.getItem("persist:v713-demo1-auth")).user != undefined ?
                    JSON.parse(JSON.parse(localStorage.getItem("persist:v713-demo1-auth")).user).data.stFirstName != "" ? JSON.parse(JSON.parse(localStorage.getItem("persist:v713-demo1-auth")).user).data.stFirstName : "dev" : "dev"}
