  ...
  return (
    <>
      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        {/*begin::1 Level*/}
        <li
          className={`menu-item ${getMenuItemActive("/DashboardPage", true)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/DashboardPage">
        ...
        <li
          className={`menu-item ${getMenuItemActive("/ManageApplication", true)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/ManageApplication">
            <span className="svg-icon menu-icon">
          ...
          <div className="menu-submenu ">
            ...
            <ul className="menu-subnav">
              <li
                className={`menu-item ${getMenuItemActive("/AddApplicationPage")}`}
                aria-haspopup="true" style={{ display: 'none' }}
              >
                <NavLink className="menu-link" to="/AddApplicationPage">
        ...
        {/* <li
          ...
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/Insurancetypes">
            <span className="svg-icon menu-icon">
              <SVG
                src={toAbsoluteUrl("/media/svg/icons/Layout/Layout-right-panel-2.svg")}
              />
            </span>
            <span className="menu-text">Insurance Types</span>
          </NavLink>
          <div className="menu-submenu ">
            <i className="menu-arrow" />
            <ul className="menu-subnav">
              ...
              <li
                className={`menu-item ${getMenuItemActive("/Insurancetypes/Insurancetype")}`}
                aria-haspopup="true" style={{ display: 'none' }}
              >
                <NavLink className="menu-link" to="/Insurancetypes/Insurancetype">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                </NavLink>
        ...
        <li
          ...
          <div className="menu-submenu ">
            ...
            <ul className="menu-subnav">
              ...
              <li
                className={`menu-item ${getMenuItemActive("/appsetting")}`}
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/appsetting">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text">App Setting</span>
              ...
              <li
                className={`menu-item ${getMenuItemActive("/manage/RewardSetting")}`}
                aria-haspopup="true" style={{ display: 'none' }}
              >
                <NavLink className="menu-link" to="/manage/RewardSetting">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text">View Reward Setting</span>
                </NavLink>
              </li>
            </ul>
          </div>
        ...
        <li
          ...
          aria-haspopup="true"
          data-menu-toggle="hover">
          <NavLink className="menu-link menu-toggle" to="/ErrorLog">
            <span className="svg-icon menu-icon">
              <SVG
          ...
          <div className="menu-submenu ">
            ...
            <ul className="menu-subnav">
              ...
              <li
                className={`menu-item ${getMenuItemActive("/ErrorLog")}`}
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/ErrorLog">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text">Error log</span>
              ...
              <li
                className={`menu-item ${getMenuItemActive("/ErrorLog/view")}`}
                aria-haspopup="true" style={{ display: 'none' }}
              >
                <NavLink className="menu-link" to="/ErrorLog/view">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text">View Error log Details</span>
                </NavLink>
              </li>
