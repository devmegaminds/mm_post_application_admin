        ...
        if (nextProps.GetAdminUserDataResponse) {
            if (nextProps.GetAdminUserDataResponse && nextProps.GetAdminUserDataResponse != this.props.GetAdminUserDataResponse) {
                if (nextProps.GetAdminUserDataResponse.statusCode == 200) {
                    ...
                    this.setState({ totalno: nextProps.GetAdminUserDataResponse.data[0].TotalRecords });
                    // var userDataResponse = nextProps.GetAdminUserDataResponse.data 
                    // var newArray = userDataResponse.data.filter(function (el) {
                    //     return el.stUserType == 2;
                    // });
                    // console.log(newArray,"1212121");
                    this.setState({ userResponseData: nextProps.GetAdminUserDataResponse.data }, () => {
                    });
